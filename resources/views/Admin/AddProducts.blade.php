                    ...
                    <div class="mb-3">
                        ...
                        <select name="product_category" id="product_category" class="form-select" required>
                            ...
                            <option value="Electronics" {{ old('product_category') == 'Electronics' ? 'selected' : '' }}>
                                Electronics</option>
                            <option value="Clothing" {{ old('product_category') == 'Clothing' ? 'selected' : '' }}>Clothing
                            </option>
                            <option value="Books" {{ old('product_category') == 'Books' ? 'selected' : '' }}>Books</option>
                            <option value="Accessories" {{ old('product_category') == 'Accessories' ? 'selected' : '' }}>
                                Accessories</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img id="preview-image" src="#" alt="Preview"
                                style="display: none; width: 120px; border: 1px solid #ccc; padding: 5px; border-radius: 5px;">
                        </div>
                    </div>
